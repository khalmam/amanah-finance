...
const RegisterEntrepreneur = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 flex items-center justify-center p-4 relative overflow-hidden w-screen">
